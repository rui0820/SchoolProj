...
public class Student {
	...
	//多参构造，实现对学生信息的赋值
	public Student(String sutdentNo,String studentName,String studentSex,int studentAge) {
		this.setStudentNo(sutdentNo);
		this.setStudentName(studentName);
		this.setStudentSex(studentSex);
		this.setStudentAge(studentAge);
	}
	//多参构造，实现对全部属性的赋值
	public Student(String sutdentNo,String studentName,String studentSex,int studentAge,Subject studentSubject) {
		this.setStudentNo(sutdentNo);
		this.setStudentName(studentName);
		this.setStudentSex(studentSex);
		this.setStudentAge(studentAge);
